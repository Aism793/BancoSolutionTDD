...
namespace Banco.Domain.Test.TarjetasCredito
{
    ...
    internal class TarjetaCredito
    {
        ...
        internal string Consignar(decimal valorConsignacion, DateTime fecha)
        {
            ...
            if (valorConsignacion <= Saldo)
            {
                ...
                _movimientos.Add(new Movimiento(tarjetaCredito: this, fecha: fecha, tipo: "CONSIGNACION", valor: valorConsignacion));
        ...
        internal string Retirar(decimal valorRetiro, DateTime fecha)
        {
            ...
            {
                Cupo -= valorRetiro;
                _movimientos.Add(new Movimiento(tarjetaCredito: this, fecha: fecha, tipo: "RETIRO", valor: valorRetiro));
    ...
    internal class Movimiento
    {
        ...
        public Movimiento(TarjetaCredito tarjetaCredito, DateTime fecha, string tipo, decimal valor)
        {
